...
export default function SubscriptionSection() {
  ...
  const renderCard = (number, title, monthly, yearly, note) => (
    <MKBox
      borderRadius="lg"
      shadow="md"
      p={3}
    ...
    <section id="subscriptions">
      <MKBox pt={12} px={2}>
        ...
        <MKBox
          ...
          mb={6}
        >
          {renderCard("1", "Student", "15$", "150$", "+Access to reservation")}
          {renderCard("2", "Professionals", "20$", "200$", "+Access to reservation")}
